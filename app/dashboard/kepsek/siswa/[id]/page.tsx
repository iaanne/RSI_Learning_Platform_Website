  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        {/* KIRI: SECTION 1 (PROFIL) & SECTION 2 (ORANG TUA) */}
        ...
        {/* KANAN: SECTION 3 (GAMBARAN STATS) SAMPAI SECTION 7 */}
        <div className="md:col-span-2 space-y-6">
          
          {/* SECTION 3 — STATISTIK BELAJAR UTAMA (CARD) */}
          ...
          {/* SECTION 4 — PROGRESS SUMMARY BARS */}
          ...
          {/* SECTION 5 — RIWAYAT MATAPELAJARAN TABLE */}
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
          ...
          {/* GRID UNTUK RIWAYAT KUIS (SECTION 6 & 7 COMBINED) */}
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
